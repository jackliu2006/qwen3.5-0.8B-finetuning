...
model = AutoModelForCausalLM.from_pretrained(
    model_name, dtype="auto",  device_map="auto", quantization_config=bnb_config)
...
tokenized_dataset = dataset.map(
    tokennize_dataset, batched=True, remove_columns=dataset.column_names)
...
training_args = TrainingArguments(
   ...
   # bf16=True,  # Use bfloat16 if supported by the hardware
    # CRITICAL: Recomputes activations instead of storing them
